    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('course_group.update') }}" id="course-group-update" method="post"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input value="{{ $this_course_groups->name }}" type="text" id="text-input" name="name" class="form-control" placeholder="نام کامل گروه بندی">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input value="{{ $this_course_groups->title }}" type="text" id="text-input" name="title"
                                       class="form-control" placeholder="عنوان کامل گروه بندی">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <textarea class="form-control" name="abstract" id="" rows="3">{{ $this_course_groups->abstract }}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 form-control-label" for="">متن کامل:</label>
                            <div class="col-md-9">
                                <textarea class="form-control" name="text" id="" rows="6">{{ $this_course_groups->text }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <textarea class="form-control" name="description" id=""
                                          rows="3">{{ $this_course_groups->description }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input value="{{ $this_course_groups->keywords }}" type="text" id="" name="keywords" class="form-control" placeholder="کلمات کلیدی">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9 d-flex justify-content-center align-items-center">
                                <div class="box-thumbnail-lg position-relative">
                                    ...
                                    <img class="w-100 preview-image" src="{{ asset('storage/'.$this_course_groups->icon) }}" alt="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9 d-flex justify-content-center align-items-center">
                                <div class="box-thumbnail-lg position-relative">
                                    ...
                                    <img class="w-100 preview-image" src="{{ asset('storage/'.$this_course_groups->header_image) }}" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    ...
                                    <input class="form-control" type="number" min="0" value="{{ $this_course_groups->order }}" name="order" >
                            ...
                            <div class="col-md-9">
                                <div class="checkbox">
                                    <label for="">
                                        ...
                                        <input {{ $checked }} class="form-check-input" type="checkbox" id=""
                                               name="status">
                                    </label>
                                </div>
                            </div>
                ...
                <div class="card-footer">
                    <button type="ارسال" id="submit-course-group-update" class="btn btn-sm btn-primary"><i
