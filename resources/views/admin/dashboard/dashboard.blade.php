                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="callout callout-info">
                                        <small class="text-muted">مشتری های جدید</small>
                                        <br>
                                ...
                                <div class="col-sm-6">
                                    <div class="callout callout-danger">
                                        <small class="text-muted">مشتریان تکراری</small>
                                        <br>
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="callout callout-warning">
                                        <small class="text-muted">تعداد بازدید صفحات</small>
                                        <br>
                                ...
                                <div class="col-sm-6">
                                    <div class="callout callout-success">
                                        <small class="text-muted">مشتریان سازمانی</small>
                                        <br>
                            ...
                            <ul class="horizontal-bars type-2">
                                ...
                                <li>
                                    ...
                                    <span class="title">لیندکدین</span>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="callout callout-primary">
                                        <small class="text-muted">  ضریب بازگشت</small>
                                        <br>
                            ...
                            <ul class="icons-list">
                                <li>
                                    ...
                                    <div class="desc">
                                        ...
                                        <small>یک نمونه متن </small>
                                    </div>
                                    <div class="value">
                                        <div class="small text-muted">فروش های هفته</div>
                                        <strong>1.924</strong>
                                    </div>
                                    <div class="لینک شماره ۱s">
                                ...
                                <li>
                                    ...
                                    <div class="value">
                                        <div class="small text-muted">دانلود</div>
                                ...
                                <li>
                                    ...
                                    <div class="desc">
                                        <div class="title">عکس</div>
                                        <small>یک نمونه متن </small>
                                    </div>
                                    <div class="value">
                                        <div class="small text-muted">آپلودها</div>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="small text-muted">
                                    <span>جدید</span>| عضویت:1 تیر , ۱۳۹۵
                                </div>
                            </td>
                            <td class="text-center">
                            ...
                            <td>
                                <div class="small text-muted">آخرین ورود</div>
                                <strong>۱۰ ثانیه پیش</strong>
                            </td>
                        </tr>
                        <tr>
                            <td class="text-center">
